...
export async function buildSystemPrompt() {
  ...
  return [
    ...
    '',
    '## Tool Usage',
    'You have tools available to fetch projects, READMEs, and documents—use them ONLY when the conversation clearly calls for it.',
    '**When you do use a tool, briefly explain why you\'re fetching that information before calling it.**',
